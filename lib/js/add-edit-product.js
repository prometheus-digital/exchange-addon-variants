	...
	it_exchange_variants_add_edit_product(window.jQuery, window, document);
		...
		$(function() {
			...
			$( '.it-exchange-existing-variants' ).on( 'click', '.add-variant-value-button', function() {
				...
				clone.find( '.new-variant-name-field' ).attr( 'name', 'it-exchange-product-variants[variants][' + options.id + '][title]' ).end().find('.new-variant-parent-field').attr('name', 'it-exchange-product-variants[variants][' + options.id + '][post_parent]' ).end().find('.it-exchange-variants-colorpicker').attr('name','it-exchange-product-variants[variants][' + options.id + '][color]').end().find(':disabled').removeAttr('disabled');
